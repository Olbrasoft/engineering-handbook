# Engineering Handbook - Claude Code Index

**You are:** Claude Code  
**Working on:** .NET projects in Olbrasoft ecosystem

## What Do You Need?

### 🔍 Code Review
**Task:** Run automated `/code-review` command or setup CLAUDE.md  
...
**Navigation:** Each subfolder has its own `CLAUDE.md` index with detailed guidance.
